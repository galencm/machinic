...
Run `dss-ui` with an xml file created for a boook source in the same structure as the one used in this tutorial(your paths may be different):
```
python3 ~/dss-ui/dss_ui.py --size=1500x800 -- --xml-file ~/machinic/tutorial_boook.xml
```
